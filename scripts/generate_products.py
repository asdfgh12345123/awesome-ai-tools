...
def page_wrap(title, description, canonical, body):
    return (
        ...
        '.preparing{background:#1e3a5f;color:#93c5fd}'
        '.coming{background:#7c2d12;color:#fdba74}'
        'h1{color:#818cf8}'
        'ul{margin-left:18px}'
...
products_body = (
    ...
    '  <h3>Codex Automation Starter Kit <span class="status preparing">Preparing for release</span></h3>'
    ...
    '  <p>Includes: project checklist, Codex prompts, GitHub Actions templates, Windows commands reference, and token safety guide.</p>'
    '  <p>Format: Markdown files (free to read, open source)</p>'
    '  <p><a href="codex-automation-starter-kit/">View starter kit contents</a></p>'
    '</div>'
    '<div class="card">'
