...
products_body = (
    ...
    '  <h3>Codex Automation Starter Kit <span class="status free">Lite: Free</span> <span class="status pro">Pro: 49 CNY</span></h3>'
    ...
    '  <p><strong>Pro version (49 CNY)</strong>: Full package with additional templates, complete working scripts, advanced guides, and ready-to-use examples. Delivered via Ko-fi or Afdian.</p>'
    '  <p><a href="codex-automation-starter-kit/">View product details</a></p>'
    '  <p class="disclaimer"><small>Ko-fi / Afdian listing link will be added after manual upload.</small></p>'
    '</div>'
    '<div class="card">'
