...
def render(title, description, keywords, h1, intro, body):
...
slug = 'free-ai-tools'
guide_pages.append((slug, 'Best Free AI Tools in 2026', 'A focused list of free or freemium AI tools for coding, writing, research, and productivity.', 'free AI tools, best free AI, free AI apps, AI tools no cost', 'Best Free AI Tools in 2026', 'This guide highlights tools that can be used without a paid plan, or that offer meaningful free tiers.', f'<h2>Free and Freemium Picks</h2><table><tr><th>Tool</th><th>Pricing</th><th>Description</th></tr>{rows}</table>'))
...
guide_pages.append((slug, 'ChatGPT Prompts for Coding in 2026', 'Copy-paste prompts for code review, debugging, testing, refactoring, and documentation.', 'ChatGPT prompts for coding, coding prompts, AI prompts for developers', 'ChatGPT Prompts for Coding in 2026', 'Use these prompts when you need faster debugging, cleaner refactors, and better explanations.', f'{items}<p>Browse more: <a href="../prompts/">full prompt library</a></p>'))
